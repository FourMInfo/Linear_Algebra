...
You can check out the [Jupyter notebook](https://github.com/FourMInfo/Linear_Algebra/blob/main/notebooks/Linear_Algebra_Geometry.ipynb) associated with this documentation to see worked out examples of concepts covered in the text. There are also a couple of Julia files:
